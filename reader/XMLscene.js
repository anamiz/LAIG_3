...
class XMLscene extends CGFscene {
    ...
    update(t){
        this.last=this.last||0.0;
        this.delta=t-this.last||0.0;
        this.delta=this.delta/1000;
        this.current=(this.current+this.delta)||0.0;
    ...
    changeCamera(newCamera)
    {
        ...
        this.sceneCamera = this.graph.views[newCamera];
    ...
    onGraphLoaded() {
        ...
        this.interface.addViews2(this.graph.views);
    ...
    display() {
        ...
        var i=0;
        for (var key in this.lightsKey) {
            if(this.lightsKey[key])
            {   this.lights[i].setVisible(true);
                this.lights[i].enable();
            }
            else{
